...
do
  ...
  local gold_normal_texture_def = get_texture_definition(TEXTURE.DATA_TEXTURES_FLOORMISC_0)
  gold_normal_texture_def.width = 128
  gold_normal_texture_def.height = 128
  gold_normal_texture_def.tile_width = 128
  gold_normal_texture_def.tile_height = 128
  gold_normal_texture_def.texture_path = "res/arrowtrap_gold_normal.png"
  gold_normal_texture_id = define_texture(gold_normal_texture_def)
end
...
function module.create_arrowtrap(x, y, l)
  ...
  elseif state.theme == THEME.CITY_OF_GOLD then
    ...
    entity.rendering_info:set_normal_map_texture(gold_normal_texture_id)
    entity.rendering_info.shader = 30
  end
end
